...
class SellerFindIdScreen extends StatefulWidget {
  const SellerFindIdScreen({required this.onFindId, super.key});

  final Future<String> Function(String name, String phone) onFindId;

  @override
  State<SellerFindIdScreen> createState() => _SellerFindIdScreenState();
}

class _SellerFindIdScreenState extends State<SellerFindIdScreen> {
          ...
          children: [
            ...
            if (_foundEmail != null) ...[
              ...
              OutlinedButton(
                ...
                onPressed: () => context.go(SellerRoutes.signIn),
