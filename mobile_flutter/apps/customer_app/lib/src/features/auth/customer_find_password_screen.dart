...
class CustomerFindPasswordScreen extends StatefulWidget {
  const CustomerFindPasswordScreen({
  ...
  @override
  State<CustomerFindPasswordScreen> createState() =>
      _CustomerFindPasswordScreenState();
}

class _CustomerFindPasswordScreenState
    extends State<CustomerFindPasswordScreen> {
