      ...
      body: FutureBuilder<List<PlatformAnnouncement>>(
        ...
        builder: (BuildContext context, snapshot) {
          if (snapshot.connectionState != ConnectionState.done) {
            return const PopqLoadingView(message: '공지사항을 불러오고 있어요.');
          }
            ...
            return RefreshIndicator(
              ...
              child: ListView(
                ...
                children: const <Widget>[
                  ...
                  SizedBox(height: PopqSpacing.md),
                  Center(child: Text('등록된 공지사항이 없습니다.')),
                ],
              ),
            );
          }
            ...
            child: ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Card(
                  child: ListTile(
                    key: Key(
                      'customer-platform-announcement-${item.platformAnnouncementId}',
                    ),
...
class CustomerPlatformAnnouncementDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<PlatformAnnouncement>(
        future: repository.findOne(platformAnnouncementId),
        builder: (BuildContext context, snapshot) {
          if (snapshot.connectionState != ConnectionState.done) {
            return const PopqLoadingView(message: '공지사항을 불러오고 있어요.');
          }
          if (!snapshot.hasData) {
            return const PopqErrorView(message: '공지사항을 찾을 수 없어요.');
          }
