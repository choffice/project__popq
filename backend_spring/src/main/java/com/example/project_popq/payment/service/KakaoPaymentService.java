...
public class KakaoPaymentService {
    ...
    public KakaoPaymentPrepareResponse prepareCustomer(
        ...
        if (payment != null) {
            ...
            /*
             * 같은 요청이 이미 승인된 경우에는 결제를 다시 준비하지 않고
             * 현재 결제 상태를 그대로 반환합니다.
             */
            ...
            /*
             * 아직 유효한 카카오페이 redirect URL이 있으면
             * 외부 ready API를 다시 호출하지 않습니다.
             */
        ...
        if (payment == null) {
            ...
            /*
             * paymentId를 카카오페이 callback URL에 넣기 위해
             * ready 호출 전에 먼저 INSERT합니다.
             */
    ...
    private String createPartnerUserId(
        ...
        /*
         * 이메일이나 전화번호 대신 POPQ 내부 회원 ID를 사용합니다.
         */
    ...
    private Instant resolveProviderExpiresAt(
        ...
        return readyExpiresAt.isBefore(
                orderExpiresAt
        )
                ? readyExpiresAt
                : orderExpiresAt;
